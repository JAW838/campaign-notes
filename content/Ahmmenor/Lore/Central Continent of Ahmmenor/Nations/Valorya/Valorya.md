Rulers: [[The Guardian Council]]*
The map is slightly inaccurate. The island with two mountains should be split into two islands with one mountain each, resulting in one large island and two smaller ones.
The group of islands is called Murder. The names of the islands in descending size is:
1. Big: Cruelty
2. Medium: Disdain
